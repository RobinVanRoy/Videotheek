    ...
    <body class="body">
        ...
        <div class="left">
            ...
            <div class="details">
                <table>
                    <tr>
                        <td class="inhoud"><label>Titel:</label></td>
                        <td><textarea rows="1" cols="75" disabled="true"><% if(null == session.getAttribute("Titel")){%><%}else{%>"${sessionScope.Titel}"<%}%></textarea></td>
                    </tr>
                    <tr>
                        <td class="inhoud"><label>Genre:</label></td>
                        <td><textarea rows="1" cols="75" disabled="true"><% if(null == session.getAttribute("Genre")){%><%}else{%>"${sessionScope.Genre}"<%}%></textarea></td>
                    </tr>
                    <tr>
                        <td class="inhoud"><label>Jaar:</label></td>
                        <td><textarea rows="1" cols="75" disabled="true"><% if(null == session.getAttribute("Jaar")){%><%}else{%>"${sessionScope.Jaar}"<%}%></textarea></td>
                    </tr>
                    <tr>
                        <td class="inhoud"><label>Acteurs/Actrices:</label></td>
                        <td><textarea rows="1" cols="75" disabled="true"><% if(null == session.getAttribute("Acteurs")){%><%}else{%>"${sessionScope.Acteurs}"<%}%></textarea></td>
                    </tr>
                    <tr>
                        <td class="inhoud"><label>Inhoud:</label></td>
                        <td><textarea rows="20" cols="75" disabled="true"><% if(null == session.getAttribute("Inhoud")){%><%}else{%>"${sessionScope.Inhoud}"<%}%></textarea></td>
                    </tr>
                </table>
            </div>        
        </div>
