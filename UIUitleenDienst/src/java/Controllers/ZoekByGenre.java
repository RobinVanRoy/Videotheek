 ...
 * @author Ikke
 */
public class ZoekByGenre extends HttpServlet {
    ...
    /* Handelt het zoeken naar een genre en geeft een lijst terug */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(!"".equals(genre))
            {
                ...
                for(Film f : films)
                {                 
                    if(f.getGenre().toLowerCase().contains(genre) == false)
                    {
                        films2.add(f);
                    }
                }
            ...
            {
                String error = "Verplicht een Genre in te geven!";
